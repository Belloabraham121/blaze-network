  ...
  const aiFeatures = [
    {
      ...
      example:
        "You: 'Can you send $20 to my brother?'\nBlaze AI: 'I'll help you send $20 USDC! What's your brother's phone number? 💰'",
    ...
    },
    {
      ...
      example:
        "🎤 Voice: 'Check my balance'\nBlaze AI: 'You have $127.45 USDC! 📊 Your staking earned $0.23 today! 🎉'",
    ...
    },
    {
      ...
      example:
        "Usuario: 'Enviar dinero'\nBlaze AI: '¡Perfecto! ¿A quién quieres enviar dinero? 🇪🇸'",
    ...
    },
    {
      ...
      example:
        "Blaze AI: '🔥 Great time to stake! Network fees are 40% lower right now. Want to stake your idle USDC?'",
    ...
    },
    {
      ...
      example:
        "🚨 Blaze AI: 'Unusual transaction detected! Someone asking for wallet info? That's a scam - I'll never ask for that!'",
    ...
    },
    {
      ...
      example:
        "🎤 Voice: 'Show my portfolio'\nBlaze AI: 'Here's your portfolio! 📈 [Sends detailed chart image]'",
