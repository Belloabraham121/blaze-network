...
export function WhatsAppAIDemo() {
  ...
  const demoScenarios = [
    ...
    },
    {
      ...
      steps: [
        {
          text: "🎤 [Voice Message: 'Hey Blaze, envía 30 dólares a mi mamá']",
          isUser: true,
        },
        {
